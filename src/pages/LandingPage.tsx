...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0A0F1E] text-slate-100 font-sans overflow-hidden">
      {/* Background Blobs */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] radial-blob-green rounded-full pointer-events-none" />
      <div className="absolute top-[20%] right-[-10%] w-[50%] h-[50%] radial-blob-blue rounded-full pointer-events-none" />
      <div className="absolute bottom-[20%] left-[-20%] w-[60%] h-[60%] radial-blob-green rounded-full pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] radial-blob-blue rounded-full pointer-events-none" />
      ...
      <header className="fixed top-0 left-0 right-0 z-50 glass-panel border-b border-border-subtle/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#how-it-works" className="text-sm font-medium text-slate-400 hover:text-primary transition-colors">How It Works</a>
            <a href="#features" className="text-sm font-medium text-slate-400 hover:text-primary transition-colors">Features</a>
            <a href="#apps" className="text-sm font-medium text-slate-400 hover:text-primary transition-colors">Apps</a>
          ...
          <div className="hidden md:flex items-center gap-4">
            {currentAdmin ? (
              <button 
                ...
                className="px-5 h-11 rounded-xl text-sm font-semibold border border-border-subtle hover:border-primary transition-all duration-300 text-slate-200"
              >
                Go to Dashboard
              </button>
            ) : (
            ...
            <a 
              href="#contact" 
              className="px-5 h-11 rounded-xl bg-primary hover:bg-primary/80 text-[#0A0F1E] text-sm font-bold flex items-center justify-center shadow-lg shadow-primary/20 transition-all duration-300"
            >
              Get a Demo
            </a>
          </div>
        ...
        {/* Mobile Nav Overlay */}
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-20 left-0 right-0 bg-[#0A0F1E] border-b border-border-subtle/80 flex flex-col p-6 gap-5 shadow-2xl transition-all duration-300">
            <a href="#how-it-works" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold text-slate-300 hover:text-primary">How It Works</a>
            <a href="#features" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold text-slate-300 hover:text-primary">Features</a>
            <a href="#apps" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold text-slate-300 hover:text-primary">Apps</a>
            <a href="#pricing" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold text-slate-300 hover:text-primary">Pricing</a>
            <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="text-base font-semibold text-slate-300 hover:text-primary">Contact</a>
            ...
            <div className="flex flex-col gap-3">
              <button 
                ...
                className="w-full h-12 rounded-xl text-sm font-semibold border border-border-subtle text-slate-200 flex items-center justify-center"
              >
                Admin Login
              </button>
              <a 
                ...
                className="w-full h-12 rounded-xl bg-primary text-[#0A0F1E] text-sm font-bold flex items-center justify-center shadow-lg shadow-primary/10"
              >
                Get a Demo
              </a>
            </div>
      ...
      <section id="home" className="relative min-h-screen pt-32 pb-20 flex flex-col items-center justify-center px-6">
        <div className="max-w-6xl mx-auto text-center flex flex-col items-center">
          ...
          <h1 className="font-heading font-bold text-5xl md:text-7xl tracking-tight leading-none text-white max-w-4xl mb-8">
          ...
          <p className="text-base md:text-xl text-text-muted max-w-3xl mb-12 font-sans font-light leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mb-16">
            <a 
              href="#contact" 
              className="w-full sm:w-auto px-8 h-14 bg-primary hover:bg-primary/80 text-[#0A0F1E] font-bold rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-primary/30 transition-all duration-300 text-base"
            >
              Get a Demo
            </a>
            <a 
              href="#features" 
              className="w-full sm:w-auto px-8 h-14 bg-[#111827]/80 hover:bg-[#111827] border border-border-subtle rounded-xl flex items-center justify-center gap-2 hover:border-primary/50 transition-all duration-300 text-base"
            >
          ...
          <div className="w-full max-w-4xl glass-panel border border-border-subtle/80 rounded-2xl p-6 grid grid-cols-1 md:grid-cols-3 gap-6 mb-24 relative overflow-hidden">
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="font-heading font-bold text-lg md:text-xl text-white">3 Apps in One Platform</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-xs font-mono text-secondary uppercase tracking-wider mb-2">Cross-Platform Tech</span>
              <span className="font-heading font-bold text-lg md:text-xl text-white">Android · iOS · Web</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-xs font-mono text-primary uppercase tracking-wider mb-2">Scale Ready</span>
              <span className="font-heading font-bold text-lg md:text-xl text-white">Built for Gated Communities</span>
            </div>
          </div>

          {/* Floating Mockup screens representation */}
          <div className="relative w-full max-w-5xl h-[300px] md:h-[480px] bg-gradient-to-t from-[#0A0F1E] via-[#0A0F1E]/80 to-transparent flex items-center justify-center">
            {/* Ambient glow in center */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] radial-blob-green rounded-full opacity-60 pointer-events-none" />
            ...
            <div className="absolute bottom-0 w-[80%] md:w-[70%] h-[75%] md:h-[80%] glass-panel rounded-t-2xl shadow-2xl border border-border-subtle/80 overflow-hidden translate-y-4">
              <div className="bg-[#1F2937]/50 h-8 px-4 flex items-center gap-2 border-b border-border-subtle">
                ...
                <div className="h-4 w-48 rounded bg-[#111827] mx-auto text-[9px] font-mono text-slate-500 flex items-center justify-center">
                  admin.elevoras.in/dashboard
                </div>
              </div>
              <div className="p-4 grid grid-cols-4 gap-3 bg-[#0A0F1E]/40 h-full">
                <div className="col-span-1 border-r border-border-subtle/40 pr-2 flex flex-col gap-2">
                  ...
                  <div className="h-6 rounded bg-[#111827]/80 border border-border-subtle/30" />
                  <div className="h-6 rounded bg-[#111827]/80" />
                  <div className="h-6 rounded bg-[#111827]/80" />
                  <div className="h-6 rounded bg-[#111827]/80" />
                </div>
                <div className="col-span-3 flex flex-col gap-3">
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <div className="h-12 rounded bg-surface border border-border-subtle/50 p-1.5 flex flex-col justify-between">
                      <div className="h-2 w-12 rounded bg-slate-600" />
                      <div className="h-4 w-8 rounded bg-emerald-500/30" />
                    </div>
                  </div>
            ...
            <div className="absolute left-0 bottom-4 w-[28%] md:w-[22%] h-[65%] md:h-[75%] glass-panel rounded-2xl shadow-2xl border border-border-subtle/80 overflow-hidden -rotate-6 translate-x-2 md:-translate-x-8 animate-float">
              <div className="h-5 w-full bg-[#111827] flex items-center justify-between px-3 text-[8px] font-mono text-slate-500">
                <span>09:41 AM</span>
              ...
              <div className="p-3 flex flex-col gap-3 bg-[#0A0F1E]/80 h-full">
                ...
                <div className="h-16 rounded-xl bg-surface border border-border-subtle p-2 flex flex-col justify-between">
                  ...
                  <div className="h-6 w-full bg-primary hover:bg-primary/80 rounded flex items-center justify-center text-[8px] font-bold text-[#0A0F1E]">
                    Pay Wash Invoice
                  </div>
                </div>
              </div>
              ...
              <div className="p-3 flex flex-col gap-3 bg-[#0A0F1E]/80 h-full">
                ...
                <div className="h-24 rounded-xl bg-surface border border-border-subtle/80 p-2 flex flex-col justify-between">
                  ...
                  <div className="grid grid-cols-2 gap-1">
                    ...
                    <div className="h-10 bg-slate-800 rounded-lg flex flex-col items-center justify-center text-[7px] text-slate-400">
                      <span>A-304</span>
                      <span>1 Wash Left</span>
                    </div>
                  </div>
                  <div className="h-4 w-full bg-secondary/80 rounded flex items-center justify-center text-[7px] font-bold text-white">
                    Submit Wash
                  </div>
                </div>
              </div>
      ...
      <section id="how-it-works" className="relative py-28 px-6 bg-[#0E1527]/40 border-y border-border-subtle/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="font-heading font-bold text-4xl md:text-5xl tracking-tight text-white mb-4">
              How Elevoras Works
            </h2>
            <p className="text-lg text-text-muted max-w-xl mx-auto font-sans font-light">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-2xl flex flex-col relative overflow-hidden group">
              ...
              <h3 className="font-heading font-bold text-xl text-white mb-4 group-hover:text-primary transition-colors">
                1. Customer App
              </h3>
              <p className="text-text-muted leading-relaxed text-sm font-sans font-light">
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-2xl flex flex-col relative overflow-hidden group">
              ...
              <h3 className="font-heading font-bold text-xl text-white mb-4 group-hover:text-secondary transition-colors">
                2. Cleaner App
              </h3>
              <p className="text-text-muted leading-relaxed text-sm font-sans font-light">
            ...
            <div className="glass-panel glass-panel-hover p-8 rounded-2xl flex flex-col relative overflow-hidden group">
              ...
              <h3 className="font-heading font-bold text-xl text-white mb-4 group-hover:text-emerald-400 transition-colors">
                3. Admin Web Portal
              </h3>
              <p className="text-text-muted leading-relaxed text-sm font-sans font-light">
          ...
          <div className="w-full glass-panel border border-border-subtle p-8 rounded-2xl overflow-x-auto">
            <h4 className="font-heading font-semibold text-lg text-slate-300 mb-6 text-center">
            ...
            <div className="min-w-[900px] flex items-center justify-between px-4 py-2 font-mono text-xs">
              <div className="flex flex-col items-center gap-2">
                <div className="px-4 py-2 rounded-lg bg-surface border border-border-subtle flex items-center gap-1.5 text-slate-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="glass-panel border-t-2 border-t-primary rounded-2xl p-8 flex flex-col justify-between">
              <div>
                ...
                <p className="text-text-muted text-sm font-sans font-light mb-8">
            ...
            {/* Card 3 - Admin Portal */}
            <div className="glass-panel border-t-2 border-t-emerald-500 rounded-2xl p-8 flex flex-col justify-between">
              <div>
                <div className="flex items-center justify-between mb-6">
              ...
              <div className="mt-8 border-t border-border-subtle pt-6">
                {currentAdmin ? (
                  <button 
                    onClick={() => navigate('/admin')}
                    className="w-full h-11 bg-emerald-500 hover:bg-emerald-500/80 text-[#0A0F1E] font-bold rounded-xl text-sm flex items-center justify-center gap-1.5 transition-colors"
                  >
      ...
      <section id="features" className="py-28 px-6 bg-[#0E1527]/40 border-y border-border-subtle/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="font-heading font-bold text-4xl md:text-5xl tracking-tight text-white mb-4">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl border border-border-subtle/50 bg-[#111827]/40 backdrop-blur flex flex-col justify-between">
              <p className="text-slate-300 font-sans italic text-sm leading-relaxed mb-6">
            ...
            <div className="p-6 rounded-2xl border border-border-subtle/50 bg-[#111827]/40 backdrop-blur flex flex-col justify-between">
              ...
              <div className="font-mono text-xs">
                <div className="text-emerald-400 font-bold">PCI-Compliant Billing</div>
      ...
      <section className="py-24 px-6 bg-[#0E1527]/40 border-t border-border-subtle/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-text-muted max-w-xl mx-auto text-sm font-sans font-light">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
            ...
            <div className="lg:col-span-3 glass-panel rounded-2xl p-8 relative overflow-hidden border border-primary/30">
              ...
              <div className="flex items-baseline gap-2 mb-4">
                <span className="font-heading font-bold text-4xl md:text-5xl text-white">₹2,50,000</span>
                <span className="text-text-muted text-sm font-sans">One-Time Development Fee</span>
              </div>
              ...
              {/* Milestones */}
              <h4 className="font-heading font-semibold text-slate-300 mb-4 border-b border-border-subtle pb-2 text-sm">
                ...
                {[
                  ...
                  <div key={idx} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 rounded-lg bg-surface border border-border-subtle/50">
                    <div className="mb-1 sm:mb-0">
                      <span className="font-bold text-slate-200">{mil.title}</span>
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="glass-panel rounded-2xl p-6 border border-border-subtle">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <div key={app.id} className="border border-border-subtle/80 rounded-xl overflow-hidden bg-[#0A0F1E]/50">
                      <button 
                        onClick={() => toggleAccordion(app.id)}
                        className="w-full p-4 flex items-center justify-between font-sans text-xs font-semibold text-slate-200 hover:bg-[#111827] transition-all"
                      >
                        <span>{app.title}</span>
                      ...
                      {pricingOpen === app.id && (
                        <div className="p-4 border-t border-border-subtle bg-[#111827]/30 text-[11px] font-sans text-text-muted leading-relaxed">
                          <div className="flex justify-between mb-2">
                            <span>Development Cost:</span>
                            <strong className="text-slate-200">{app.cost}</strong>
                          </div>
                          <div className="flex justify-between mb-3 border-b border-border-subtle pb-2">
                            <span>Store Deployment:</span>
                            <strong className="text-slate-200">{app.store}</strong>
                          </div>
                          <p>{app.details}</p>
                        </div>
                      )}
              ...
              <div className="glass-panel rounded-2xl p-6 border border-border-subtle/80 bg-gradient-to-tr from-secondary/5 to-transparent text-xs font-sans">
                <div className="font-bold text-slate-200 mb-2">AMC Details & Modes</div>
                ...
                <div className="flex flex-wrap gap-2 font-mono text-[10px] text-slate-400">
                  <span className="px-2 py-1 rounded bg-[#111827] border border-border-subtle">NEFT</span>
                  <span className="px-2 py-1 rounded bg-[#111827] border border-border-subtle">UPI</span>
                  <span className="px-2 py-1 rounded bg-[#111827] border border-border-subtle">Cheque</span>
                </div>
              </div>
      ...
      <section id="contact" className="py-28 px-6 bg-[#0E1527]/40 border-t border-border-subtle/50">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="glass-panel p-8 rounded-3xl relative overflow-hidden">
              ...
              {formSubmitted ? (
                <div className="h-[300px] flex flex-col items-center justify-center text-center p-6 bg-primary/5 rounded-2xl border border-primary/20">
                  ...
                  <h4 className="font-heading font-bold text-lg text-white mb-2">Message Transmitted!</h4>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5 text-sm font-sans">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="text-slate-400 text-xs font-semibold">Society / Organization</label>
                      <input 
                        type="text" 
                        name="org" 
                        required
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="text-slate-400 text-xs font-semibold">Mobile Number</label>
                      <input 
                        type="tel" 
                        name="phone" 
                        required
                  ...
                  <div className="flex flex-col gap-1.5">
                    <label className="text-slate-400 text-xs font-semibold">Requirements / Message</label>
                    <textarea 
                      name="message" 
                      rows={4}
                  ...
                  <button 
                    type="submit" 
                    className="h-12 rounded-xl bg-primary hover:bg-primary/80 text-[#0A0F1E] font-bold text-sm flex items-center justify-center gap-2 shadow-lg shadow-primary/20 transition-all"
                  >
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-text-muted leading-relaxed font-sans font-light mb-10 text-base">
              ...
              <div className="flex flex-col gap-6 font-mono text-sm">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@axoweb.in" className="text-slate-200 hover:text-primary transition-colors">hello@axoweb.in</a>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://axoweb.in" target="_blank" rel="noreferrer" className="text-slate-200 hover:text-secondary transition-colors">axoweb.in</a>
                  </div>
                </div>
      ...
      {/* FOOTER */}
      <footer className="py-12 px-6 border-t border-border-subtle bg-[#0A0F1E] relative z-10 text-xs text-text-muted font-sans font-light">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="font-heading font-bold text-sm text-white tracking-tight">Elevoras</span>
